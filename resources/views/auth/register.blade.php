		...
		<form method="POST" action="{{ route('register') }}">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="form-group">
						<input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required placeholder="Middle Name" />
				...
				<div class="col-sm-6">
					...
					<div class="form-group">
						<input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required placeholder="Last Name" />
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="form-group">
						<input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" placeholder="Source Code" />
			...
			<div class="col-sm-12">
				<div class="checkbox pad-btm text-left">
					...
					<label for="demo-form-checkbox">
						{{__('I agree with the')}}
						<a href="#" class="btn-link text-bold">{{__('Terms and Conditions')}}</a>
					</label>
				</div>
			</div>
