            ...
            <div class="panel bg-gray-light">
                <div class="panel-body">
                    ...
                    <ul class="list-group mar-no">
                        ...
                        <li class="list-group-item text-dark">3. Copy your Pixel ID from underneath your Site Name and paste the number directly into the Link Manager setup tab.</li>
                    </ul>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp73\htdocs\shop\resources\views/business_settings/facebook_chat.blade.php ENDPATH**/ ?>